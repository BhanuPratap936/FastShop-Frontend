...
import { FaFacebookF, FaGithub, FaHeart, FaLinkedin, FaList, FaLock, FaPhoneAlt, FaUser } from "react-icons/fa"
    ...
    return (
        <div className="w-full bg-white">
                    ...
                    h-[50px] text-slate-500">
                        ...
                        text-black">
                            ...
                            after:bg-[#afafaf] after:-right-[16px]">
                                <span><MdEmail /></span>
                                <span>support@fastShop.com</span>
                            </li>

                            <li className="flex relative justify-center items-center
                            gap-2 text-sm">
                                <span><IoCall /></span>
                                <span>011-45638926</span>
                            </li>
                        </ul>
                        ...
                        <div>
                            <div className="flex justify-center items-center gap-10">
                                ...
                                after:absolute before:absolute before:h-[18px] before:bg-[#afafaf] before:w-[1px] before:-left-[20px]">
                                    <img src="http://localhost:3000/images/language.png" alt="english" />
                                    <span><IoMdArrowDropdown /></span>

                                    <ul className="absolute invisible transition-all top-12 roudned-sm duration-200
                    ...
                    flex-wrap">
                        ...
                        <div className="md-lg:w-full w-3/12 md-lg:pt-4">
                            <div className="flex justify-between items-center">
                                <Link to='/'>
                                    <img src="http://localhost:3000/images/shop-logo.png" className="h-[50px]" alt="shop-logo" />
                                </Link>
                                <div className="justify-center items-center w-[30px] h-[30px] bg-white
                        text-slate-600 border border-slate-600 rounded-sm cursor-pointer lg:hidden md-lg:flex
            ...
            <div className="hidden md-lg:block">
                <div onClick={() => setShowSidebar(true)} className={`fixed duration-200
                    transition-all ${showSidebar ? 'invisible' : 'visible'} hidden md-lg:block w-screen
                    h-screen bg-[rgba(0,0,0,0.5)] top-0 left-0 z-20`}>



                    <div className={`w-[300px] z-[9999] transition-all duration-200 fixed
                    ${showSidebar ? '-left-[300px]' : 'left-0 top-0'} overflow-y-auto bg-white h-screen
                    py-6 px-8`}>
                        ...
                        <div className="flex justify-start flex-col gap-6">
                            ...
                            <div className="flex justify-start items-center gap-10">
                                <div className="flex group cursor-pointer text-slate-800 text-sm justify-center items-center
                                gap-1 relative after:h-[18px] after:w-[1px] after:bg-[#afafaf] after:-right-[16px] after:absolute">
                            ...
                            <div className="w-full flex justify-end md-lg:justify-start gap-3 items-center">
                                ...
                                <div className="flex justify-end flex-col gap-1">
                                    ...
                                    <span className="text-xs font-bold">Support 24/7</span>
                                </div>
                            </div>
                            ...
                            <ul className="flex flex-col justify-start items-start gap-3 text-[#1c1c1c]">
                                <li className="flex justify-start items-center gap-2 text-sm">
                                    <span><MdEmail /></span>
                                    <span className="font-bold">support@fastShop.com</span>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div className="flex w-full flex-wrap md-lg:gap-8">
                    <div className="w-3/12 md-lg:w-full">
                        <div className="bg-white relative">
                            <div onClick={() => setCategoryShow(!categoryShow)} className="h-[50px] 
                            bg-[#059473] text-white flex justify-center md-lg:justify-between md-lg:px-6
                            ...
                            <div className={`${categoryShow ? 'h-0' : 'h-[400px]'} overflow-hidden transition-all md-lg:relative
                            duration-500 absolute z-[99999] bg-[#dbf3ed] w-full border-x`}>
                        ...
                        <div className="flex flex-wrap w-full justify-between items-center md-lg:gap-6">
                                <div className="w-8/12 md-lg:w-full">
                                    <div className="flex border h-[50px] items-center relative gap-6">
                                        ...
                                        after:bg-[#afafaf] after:-right-[15px] md:hidden">
                                            <select onChange={(e) => setCategory(e.target.value)} className="w-[150px] text-slate-600
                                            font-semibold bg-transparent px-2 h-full outline-0 border-none"
                                             name="" id="">
                                ...
                                <div className="w-full flex justify-end md-lg:justify-start gap-3 items-center">
                                    <div className="w-full flex justify-end md-lg:justify-start gap-3 items-center">
                                        ...
                                        <div className="flex justify-end flex-col gap-1">
                                                <h2 className="text-md font-medium text-slate-700">+91-7456981236</h2>
