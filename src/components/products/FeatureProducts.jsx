    ...
    return (
        <div className="w-[85%] flex flex-wrap mx-auto">
            ...
            sm:grid-cols-1 gap-6">
                {
                    products.map((p, i) => <div key={i} className="border group transition-all duration-500
                    hover:shadow-md hover:-mt-3">
                        ...
                        <div className="relative overflow-hidden">

                            {
                                ...
                                p.discount ? <div className="flex justify-center items-center absolute text-white w-[38px]
                            ...
                            group-hover:bottom-3">
                                ...
                                <li onClick={() => add_cart(p._id)} className="w-[38px] h-[38px] cursor-pointer bg-white flex justify-center items-center
