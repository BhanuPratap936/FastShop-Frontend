        ...
        <div className="p-4 bg-white">
            ...
            <form>
                <div className="flex flex-col gap-1 mb-2">
                    ...
                    <input className="outline-none px-3 py-1 border rounded-md text-slate-600" type="password"
                ...
                <div>
                    <button className="px-8 py-2 bg-[#059473] shadow-lg hover:shadow-green-500/30 text-white rounded-sm">
                        Update Password
                    </button>
                </div>
            </form>
