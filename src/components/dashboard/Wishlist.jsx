...
const Wishlist = () => {
    ...
    return (
        <div className="w-full grid grid-cols-4 md-lg:grid-cols-3 md:grid-cols-2
            ...
            {
                wishlist.map((p, i) => <div key={i} className="border group transition-all duration-500
                    hover:shadow-md hover:-mt-3 bg-white rounded-md">

                    <div className="relative overflow-hidden">

                        {

                            p.discount !== 0 && <div className="flex justify-center items-center absolute text-white w-[38px]
                        ...
                        <ul className="flex transition-all duration-700 -bottom-10 justify-center items-center gap-2 absolute w-full
                            ...
                            <li onClick={() => dispatch(remove_wishlist(p._id))} className="w-[38px] h-[38px] cursor-pointer bg-white flex justify-center
